document.addEventListener('DOMContentLoaded', function() {
    const productList = document.getElementById('lista_descuentos'); // Obtiene la referencia al elemento que contiene las imágenes
    const btnSlideLeft = document.getElementById('btnsliderdescuento'); // Obtiene la referencia al botón
