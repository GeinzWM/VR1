document.addEventListener('DOMContentLoaded', function() {
    const productList = document.getElementById('listadetendecias'); // Obtiene la referencia al elemento que contiene las imágenes
    const btnSlideLeft = document.getElementById('btnslidertendencias'); // Obtiene la referencia al botón
